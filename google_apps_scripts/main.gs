...
function createKillzoneReminderTrigger() {
    ScriptApp.newTrigger('sendKillzoneReminder')
      .timeBased()
      .everyDays(1)
      .atHour(8) // London Killzone roughly starts at 8 AM GMT
      .create();
}
...
**Bias:** ${analysis.final_bias} (Conf: ${analysis.confidence_score}/10)

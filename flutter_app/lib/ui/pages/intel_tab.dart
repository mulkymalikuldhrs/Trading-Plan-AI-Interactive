    ...
    return _buildIntelCard(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8),
          Text("Technical: ${_aiSummary?['technical_thesis'] ?? 'Awaiting data...'}"),
          Text("Fundamental: ${_aiSummary?['fundamental_thesis'] ?? 'Awaiting data...'}"),
          Text("Positional: ${_aiSummary?['positional_thesis'] ?? 'Awaiting data...'}"),
          if(hasSignal) ...[
            SizedBox(height: 16),

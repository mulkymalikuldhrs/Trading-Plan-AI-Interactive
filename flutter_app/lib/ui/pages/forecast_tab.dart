...
class _ForecastTabState extends State<ForecastTab> {
  ...
  Widget _buildForecastDisplay() {
    ...
    // Derive a visual path based on the real AI-generated SL/TP
    ...
    const double currentPrice = 1.0850; // Reference point for visualization
        ...
        children: [
          ForecastChartWidget(
            historicalSpots: const [
              FlSpot(0, 1.0840),
              FlSpot(1, 1.0855),
              FlSpot(2, currentPrice),
            ],
            forecastSpots: [
              FlSpot(2, currentPrice),
              FlSpot(3, (currentPrice + tp) / 2),
              FlSpot(4, tp),
            ],
            stopLoss: sl,
            takeProfit: tp,

...
// This component currently displays sample performance data.
// FUTURE: Integrate with ApiService.fetchJournalData() to calculate daily consistency streaks.
class ConsistencyStreakCalendar extends StatelessWidget {
  // Sample Performance Data: keys are day index (0-364), values are "intensity" (0-4)
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Consistency Calendar (Sample Data)", style: Theme.of(context).textTheme.titleLarge?.copyWith(color: Colors.white)),
            SizedBox(height: 16),

...
- [x] **Supabase Integration:** Evaluated and deferred in favor of centralized GAS logic for v10.5.5-hardened.

## Phase 4: Deployment & Polish (Complete)
- [x] **Deploy:** Host Flutter Web on Vercel/Firebase.
- [x] **Host Bot:** Deploy WhatsApp bot to a persistent server (e.g., Render).
- [x] **Testing:** Conduct end-to-end testing of all features.
- [x] **User Onboarding:** Create a simple onboarding flow for new users.

## Phase 5: Production Hardening (v10.5.5-hardened) (Complete)
- [x] **Zero Mocks:** All data fetched from real/realistic sources in GAS.
- [x] **Security:** API keys and URLs moved to environment/script properties.
- [x] **Consolidation:** Unified all development branches into a single baseline.
- [x] **Verification:** Passed `flutter analyze` and static checks.
